...
![手动 PWM](screenshots/manual-pwm.png)

停转 0% / 静音 30% / 中速 50% / 全速 100% 四个圆角钢琴键，等宽并排；数值框与滑条左右并排，渐入进行时进度条带剩余秒数。

### 圆角钢琴键

![圆角钢琴键](screenshots/rounded-chips.png)

键间仅 1px 缝隙，6px 圆角既能看出圆角又不破坏整排键的连排感。
